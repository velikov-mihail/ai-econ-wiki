...
- Rebuild indexes via `python tools/build_index.py --write` (regenerates `summaries/index.md`, `concepts/index.md`, `wiki/recent.md`, and the Recent section on `wiki/index.md`)
