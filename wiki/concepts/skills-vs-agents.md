...
- [[wiki/summaries/agents-vs-skills.md|Agents vs Skills]] -- Blattman's decision framework and agent debate examples
- [[wiki/summaries/building-skills.md|Building Skills]] -- Skill development lifecycle and design patterns
- [[wiki/summaries/ai-agents-econ-research.md|AI Agents for Economic Research]] -- Panjwani's practical guide for economists
- [[wiki/summaries/agentic-everything.md|Agentic Everything]] -- Svoronos on the qualitative shift to agentic tools
- [[wiki/summaries/skill-library.md|Skill Library]] -- Curated collection of reusable skills
