...
sources:
  - "[[wiki/summaries/edgar-filings.md]]"
  - "[[wiki/summaries/web-scraping-economists.md]]"
  - "[[wiki/summaries/claude-wrds-tools.md]]"
  - "[[wiki/summaries/data-analysis-economists.md]]"
  - "[[wiki/summaries/empty-folder-to-figure.md]]"
  - "[[wiki/summaries/automated-research-finance.md]]"
...
- [[wiki/summaries/edgar-filings.md|EDGAR Filings]] -- Complete EDGAR scraping pipeline with seven lessons
- [[wiki/summaries/web-scraping-economists.md|Web Scraping for Economists]] -- Video demonstration of the EDGAR pipeline
- [[wiki/summaries/claude-wrds-tools.md|Claude WRDS Toolkit]] -- Natural language access to CRSP, Compustat, OptionMetrics, TAQ
- [[wiki/summaries/data-analysis-economists.md|Data Analysis for Economists]] -- Empty-folder-to-figure workflow
- [[wiki/summaries/empty-folder-to-figure.md|Empty Folder to Figure]] -- Detailed data acquisition and visualization walkthrough
- [[wiki/summaries/automated-research-finance.md|Automated Research in Finance]] -- Full pipeline from idea to paper
