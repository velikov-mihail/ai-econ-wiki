...
sources:
  ...
  - "[[wiki/summaries/ai-research-feedback-skills.md]]"
...
- [[wiki/summaries/feedback-machines.md]] -- Backman's structured feedback workflow and limitations
- [[wiki/summaries/ai-research-feedback-skills.md]] -- Backman's five Claude Code skills for academic review
- [[wiki/summaries/agents-vs-skills.md]] -- Blattman on self-bias and agent debates for review
- [[wiki/summaries/vibe-research.md]] -- Gregoire's multi-agent review loops in rapid paper production
- [[wiki/summaries/my-claude-code-setup.md]] -- Sant'Anna's adversarial critic-fixer loop with quality scoring
